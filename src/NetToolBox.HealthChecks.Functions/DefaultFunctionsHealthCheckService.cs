...
{
    internal class DefaultFunctionsHealthCheckService : HealthCheckService
    {
        private readonly IServiceScopeFactory _scopeFactory;
        private readonly IOptions<HealthCheckServiceOptions> _options;
        private readonly ILogger<DefaultFunctionsHealthCheckService> _logger;

        public DefaultFunctionsHealthCheckService(
            IServiceScopeFactory scopeFactory,
            IOptions<HealthCheckServiceOptions> options,
            ILogger<DefaultFunctionsHealthCheckService> logger)
        {
